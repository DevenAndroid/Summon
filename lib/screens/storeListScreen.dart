        ...
        body: SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Obx(() {
                  return nearStoreController.isDataLoading.value ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      SizedBox(
                        height: height * .02,
                      ),
                      nearStoreController.model.value.data!.isEmpty ? const Text(
                        'Stores Near You',
                        style: TextStyle(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        SizedBox(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: CachedNetworkImage(
                                              imageUrl: nearStoreController.model.value.data![index].image
                                                  .toString(),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              nearStoreController.model.value.data![index].name
                                                  .toString(),
                                              style: TextStyle(
