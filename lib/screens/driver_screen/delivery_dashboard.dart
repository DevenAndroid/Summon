...
class _DeliveryDashboardState extends State<DeliveryDashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
  return deliveryOrderListController.isDataLoading.value ? SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                deliveryOrderListController.model.value.data!.deliveredOrders.toString(),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    deliveryOrderListController.model.value.data!.pendingOrders.toString(),
                                    style: Theme.of(context)
                                        .textTheme
                                        .headline5!
                                        .copyWith(
                ...
                Obx(() {
                  return deliveryOrderListController.model.value.data!.list!.isNotEmpty ?
                  ListView.builder(
                    shrinkWrap: true,
                    itemCount: deliveryOrderListController.model.value.data!.list!.length,
                    physics: const BouncingScrollPhysics(),
                    itemBuilder: (BuildContext context, int index) {
                      var item = deliveryOrderListController.model.value.data!.list![index];
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ElevatedButton(
                                        onPressed: () {
                                          acceptOrder(orderId: item.orderId, status: "accept", context: context).then((value){
                                            if(value.status==true){
                                              deliveryOrderListController.getData();
                                              assignedController.getData();
                                              Get.toNamed(AssignedOrder.assignedOrder);
                                            }
                                          });
                                        },
                                        style: ElevatedButton.styleFrom(
                                    ...
                                    ElevatedButton(
                                        onPressed: () {
                                          acceptOrder(orderId: item.orderId, status: "decline", context: context).then((value){
                                            if(value.status==true){
                                              assignedController.getData();
                    ...
                    padding:  EdgeInsets.symmetric(horizontal: AddSize.padding20 * 5,vertical: AddSize.padding20),
                    child: SizedBox(
                        height: AddSize.size20,
