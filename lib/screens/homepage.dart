...
class HomePageState extends State<HomePage> {
                          ...
                          decoration: InputDecoration(
                              ...
                              suffixIcon: IconButton(
                                onPressed: () {
                                  ...
                                  print(homeSearchController.searchController);
  ...
  Padding buildProduct(double width, double height, int index,
                          ...
                          children: [
                            Text(
                              "₹${homeController.model.value.data!
                                  ...
                                  .varints![homeController.model.value.data!
                            ...
                            myCartController
                                ...
                                .model.value.data!.bestFreshProduct![index]
                                .varints![homeController.model.value.data!
                                .bestFreshProduct![index].varientIndex!.value]
                                .id.toString())
                                ? Container(
                                    ...
                                    InkWell(
                                      onTap: () {
                                        ...
                                        if (myCartController.model.value.data!
                                          ...
                                          addToCartRepo(homeController
                                              .model.value.data!
                                              .bestFreshProduct![index]
                                              .varints![homeController
                                              .model.value.data!
                                              .bestFreshProduct![index]
                                              .varientIndex!.value].id
                                              .toString(), int.parse(
                                              (myCartController.model.value.data!
                                    ...
                                    InkWell(
                                      onTap: () {
                                        addToCartRepo(homeController
                                            ...
                                            .model.value.data!
                                            .bestFreshProduct![index]
                                            .varientIndex!.value].id.toString(),
                                            int.parse(
                                                (myCartController.model.value.data!
                                                    .cartItems!.firstWhere((element) =>
                                                element.variantId.toString() ==
          ...
          items: List.generate(
              homeController
                  ...
                  DropdownMenuItem(
                    ...
                    child: Text(
                      "${homeController.model.value.data!
                          .bestFreshProduct![index].varints![index1]
                          .variantQty}${homeController.model.value.data!
                          .bestFreshProduct![index].varints![index1]
                          .variantQtyType}",
