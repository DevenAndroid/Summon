  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        //                                     InkWell(
        //                                         onTap: (){
        //                                           removeCartItemRepo(myCartDataController.model.value.data!.cartItems![index].id.toString(),
        //                                           context).then((value){
        ...
        //                                           });
        //                                         },
        //                                         child: Icon(Icons.clear,size: 20,color: Color(0xff000000),))
        //                                   ],
        //                                 ),
        //
        //                                 Text(myCartDataController.model.value
        //                                     .data!.cartItems![index]
        //                                     .note.toString(),
        ...
        //                                             onTap: (){
        //
        //                                               updateCartRepo(myCartDataController.model.value.data!.cartItems![index].id.toString(),
        //                                                   int.parse((myCartDataController.model.value.data!.cartItems![index].cartItemQty ?? "").toString()) -1, context).then((value){
        //                                                 if(value.status == true){
        //                                                   showToast(value.message);
        //                                                   myCartDataController.getCartData();
        //                                                 }
        ...
        //                                           ),
        //                                           Text(
        //                                             myCartDataController.model.value.data!.cartItems![index].cartItemQty.toString(),
        ...
        //
        //                                             onTap: (){
        //                                               myCartDataController.model.value.data!.cartItems![index].maxQty != myCartDataController.model.value.data!.cartItems![index].cartItemQty.toString() ?
        //                                               updateCartRepo(myCartDataController.model.value.data!.cartItems![index].id.toString(),
        //                                                   int.parse((myCartDataController.model.value.data!.cartItems![index].cartItemQty ?? "").toString()) + 1, context).then((value){
        //                                                     if(value.status == true){
        //                                                       showToast(value.message);
        //                                                       myCartDataController.getCartData();
        //                                                     }
        //                                               }): showToast("can add more than ${myCartDataController.model.value.data!.cartItems![index].maxQty} item ");
        //
        //                                             },
        //                                             child: Icon(
        //                                               Icons.add,
        ...
        //                           SizedBox(width: 10,),
        //                           Text("Free",style:  GoogleFonts.ibmPlexSansArabic(fontSize: 16,
        //                               fontWeight: FontWeight.w700,
        //                               color: Color(0xff000000)),),
        //                           Flexible(child: Container()),
        //                           Text("PickUp",style:  GoogleFonts.ibmPlexSansArabic(fontSize: 16,
        //                               fontWeight: FontWeight.w700,
        //                               color: Color(0xff000000)),),
        //                           Radio(
        //                               value: "Pickup",
        ...
        //                               child: Icon(Icons.location_on_outlined,color: Colors.white,size: 26,)),
        //                           SizedBox(width: 10,),
        //                           Text("15 SR",style:  GoogleFonts.ibmPlexSansArabic(fontSize: 16,
        //                               fontWeight: FontWeight.w700,
        //                               color: Color(0xff000000)),),
        //                           Flexible(child: Container()),
        //                           Text("Deliver to Home",style:  GoogleFonts.ibmPlexSansArabic(fontSize: 16,
        //                               fontWeight: FontWeight.w700,
        //                               color: Color(0xff000000)),),
        //                           Radio(
        //                               value: "Pickup",
        ...
        //               .cartItems != null && myCartDataController.model.value.data!
        ...
        //                   thickness: 1,
        //                 ),
        //                 details("Wallet balance", myCartDataController.model.value.data!.cartPaymentSummary!.walletSaving.toString(), "SR"),
        //                 Divider(
        //                   height: 10,
        //                   color: Color(0xffC0CCD4),
        //                   // color: Colors.grey.shade300,
