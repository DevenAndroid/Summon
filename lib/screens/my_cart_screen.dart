                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                                "Coriander Leaves And Greens Greens",
                                                style: TextStyle(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          mainAxisAlignment:
                                              MainAxisAlignment.center,
                                          children: [
                                            Text("Coriander Leaves And Greens",
                                                style: TextStyle(
                                                    color: AppTheme.blackcolor,
                              ...
                              Expanded(
                                child: Row(children: [
                                  const Image(
                                      ...
                                      width: 28,
                                      image:
                                          AssetImage(AppAssets.coupons_image)),
                                  const SizedBox(
                                    width: 8,
                                  ),
                                  Text("Use Coupons",
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text("WELCOME50 applied successfully",
                                        style: TextStyle(
                                            color: AppTheme.userActive,
                                            fontSize: AddSize.font14,
                                            fontWeight: FontWeight.w500)),
                  ...
                  child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                              onPressed: () {
                                Get.toNamed(PaymentMethod.paymentScreen);
                              },
